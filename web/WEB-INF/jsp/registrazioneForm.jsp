...
<section>
    ...
    <form name="registrazione" action="Registrazione" method="post">
        <label style="font-weight: bold">Username (almeno 6 caratteri, solo lettere e numeri, non utilizzato da altri utenti)</label>
        <input type="text" name="username" oninput="validaUsername()" style="border-style: groove">
        <label style="font-weight: bold">Password (almeno 8 caratteri, deve contenere: una lettera maiuscola, una minuscola, un numero)</label>
        <input type="password" name="password" oninput="validaPassword()" style="border-style: groove">
        <label style="font-weight: bold">Password (conferma)</label>
        <input type="password" name="passwordConferma" oninput="validaPassword()" style="border-style: groove">
        <label style="font-weight: bold">Nome (solo lettere e spazi)</label>
        <input type="text" name="nome" oninput="validaNome()" style="border-style: groove">
        <label style="font-weight: bold">Email</label>
        <input type="text" name="email" oninput="validaEmail()"style="border-style: groove">
